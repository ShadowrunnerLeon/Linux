...
const char test_string[] = "1po202898134809325085825835783bbbfjblsni4njbfbdhb2bb12nb4b43b5n3bnsdnfodnfobsbBSDB";
...
int main() 
{
    ...
    sleep(1);
    int wr = write(fd, test_string, sizeof(test_string));
    if (errno = EINTR)
    {
        printf("Interrupted\n");
    }
